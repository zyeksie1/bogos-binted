...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'kace':
				frames = Paths.getSparrowAtlas('kace/animation2');
				animation.addByPrefix('idle', 'kace idle', 24, false);
				animation.addByPrefix('singUP', 'kace up', 24, false);
				animation.addByPrefix('singRIGHT', 'kace right', 24, false);
				animation.addByPrefix('singLEFT', 'kace left', 24, false);
				animation.addByPrefix('singDOWN', 'kace down', 24, false);
